...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center justify-center w-10 h-10 rounded-lg border border-neutral-200 dark:border-white/10 bg-background dark:bg-neutral-800">
        <div className="w-4 h-4 rounded-md bg-neutral-300 animate-pulse" />
      </div>
    );
  }
    ...
    <div className="relative">
      <motion.button
        ...
        className={cn(
          ...
          'dark:border-white/10 dark:bg-neutral-800 dark:hover:bg-neutral-700',
      ...
      {isOpen && (
        <motion.div
          ...
          className={cn(
            ...
            'bg-background border-neutral-200 dark:border-white/10',
