...
export interface SiteConfig {
  ...
  analytics?: {
    ...
    mapmyvisitors_embed_url?: string;
    mapmyvisitors_globe_script_url?: string;
    mapmyvisitors_map_script_url?: string;
    mapmyvisitors_image_url?: string;
    mapmyvisitors_stats_url?: string;
  };
  navigation: Array<{
    title: string;
